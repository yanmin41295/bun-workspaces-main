<template>
  <pro-layout v-model:collapsed="state.collapsed" v-model:openKeys="state.openKeys" v-model:selectedKeys="state.selectedKeys" :breadcrumb="{ routes: breadcrumb }" :loading="loading"
              :menu-data="menuData" disable-content-margin iconfont-url="//at.alicdn.com/t/font_2804900_2sp8hxw3ln8.js" style="min-height: 100vh" v-bind="proConfig">
...
import { getMenuData, clearMenuItem, type RouteContextProps, ProLayout } from '@ant-design-vue/pro-layout';
