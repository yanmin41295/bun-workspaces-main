<template>
  <div style="margin: 50px">
    <STable :columns="columns" :scroll="{ y: 800, x: 2000 }" :pagination="false" :data-source="dataSource" :stripe="tableConfig.striped"
            :column-drag="tableConfig.columnDrag" :on-column-drag-end="handleDragColumns">
...
const tableMeta = reactive({
  ...
  columns: [
    ...
    { title: 'fixed right column10', key: 'column10', dataIndex: 'column10', fixed: 'right', width: '400px', resizable: true, order: 13 },
  ],
